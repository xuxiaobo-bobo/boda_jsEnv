// HTMLCollection对象
bodavm.memory.globalobj['HTMLCollection'] = function HTMLCollection(){if (!(this instanceof HTMLCollection)){return bodavm.toolsFunc.throwError("TypeError", "Illegal constructor")};this._boisinit=bodavm.config.isinit}
