// VisualViewport对象
bodavm.memory.globalobj['VisualViewport'] = function VisualViewport(){if (!(this instanceof VisualViewport)){return bodavm.toolsFunc.throwError("TypeError", "Illegal constructor")};this._boisinit=bodavm.config.isinit}
