// StorageManager对象
bodavm.memory.globalobj['StorageManager'] = function StorageManager(){if (!(this instanceof StorageManager)){return bodavm.toolsFunc.throwError("TypeError", "Illegal constructor")};this._boisinit=bodavm.config.isinit}
