// BeforeUnloadEvent对象
bodavm.memory.globalobj['BeforeUnloadEvent'] = function BeforeUnloadEvent(){if (!(this instanceof BeforeUnloadEvent)){return bodavm.toolsFunc.throwError("TypeError", "Illegal constructor")};this._boisinit=bodavm.config.isinit}
