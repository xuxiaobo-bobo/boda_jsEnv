// SVGUseElement对象
bodavm.memory.globalobj['SVGUseElement'] = function SVGUseElement(){if (!(this instanceof SVGUseElement)){return bodavm.toolsFunc.throwError("TypeError", "Illegal constructor")};this._boisinit=bodavm.config.isinit}
