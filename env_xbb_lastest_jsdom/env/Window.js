...
bodavm.memory.globalobj['Window'] = function Window(){if (!(this instanceof Window)){return bodavm.toolsFunc.throwError("TypeError", "Illegal constructor")};this._boisinit=bodavm.config.isinit}
// debugger
