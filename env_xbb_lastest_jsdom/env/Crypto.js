// Crypto对象
bodavm.memory.globalobj['Crypto'] = function Crypto(){if (!(this instanceof Crypto)){return bodavm.toolsFunc.throwError("TypeError", "Illegal constructor")};this._boisinit=bodavm.config.isinit}
