// HTMLLegendElement对象
bodavm.memory.globalobj['HTMLLegendElement'] = function HTMLLegendElement(){if (!(this instanceof HTMLLegendElement)){return bodavm.toolsFunc.throwError("TypeError", "Illegal constructor")};this._boisinit=bodavm.config.isinit}
