// MimeTypeArray对象
bodavm.memory.globalobj['MimeTypeArray'] = function MimeTypeArray(){if (!(this instanceof MimeTypeArray)){return bodavm.toolsFunc.throwError("TypeError", "Illegal constructor")};this._boisinit=bodavm.config.isinit}
