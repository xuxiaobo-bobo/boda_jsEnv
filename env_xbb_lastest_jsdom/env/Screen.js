// Screen对象
bodavm.memory.globalobj['Screen'] = function Screen(){if (!(this instanceof Screen)){return bodavm.toolsFunc.throwError("TypeError", "Illegal constructor")};this._boisinit=bodavm.config.isinit}
