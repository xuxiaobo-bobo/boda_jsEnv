// HTMLDivElement对象
bodavm.memory.globalobj['HTMLDivElement'] = function HTMLDivElement(){if (!(this instanceof HTMLDivElement)){return bodavm.toolsFunc.throwError("TypeError", "Illegal constructor")};this._boisinit=bodavm.config.isinit}
