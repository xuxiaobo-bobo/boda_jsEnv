...
bodavm.memory.globalobj['HTMLParagraphElement'] = function HTMLParagraphElement(){if (!(this instanceof HTMLParagraphElement)){return bodavm.toolsFunc.throwError("TypeError", "Illegal constructor")};this._boisinit=bodavm.config.isinit}
