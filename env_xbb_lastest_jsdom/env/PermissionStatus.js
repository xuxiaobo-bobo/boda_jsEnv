// PermissionStatus对象
bodavm.memory.globalobj['PermissionStatus'] = function PermissionStatus(){if (!(this instanceof PermissionStatus)){return bodavm.toolsFunc.throwError("TypeError", "Illegal constructor")};this._boisinit=bodavm.config.isinit}
