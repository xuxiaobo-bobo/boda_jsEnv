// DOMStringList对象
bodavm.memory.globalobj['DOMStringList'] = function DOMStringList(){if (!(this instanceof DOMStringList)){return bodavm.toolsFunc.throwError("TypeError", "Illegal constructor")};this._boisinit=bodavm.config.isinit}
