// SVGSymbolElement对象
bodavm.memory.globalobj['SVGSymbolElement'] = function SVGSymbolElement(){if (!(this instanceof SVGSymbolElement)){return bodavm.toolsFunc.throwError("TypeError", "Illegal constructor")};this._boisinit=bodavm.config.isinit}
