...
bodavm.memory.globalobj['XRCPUDepthInformation'] = function XRCPUDepthInformation(){if (!(this instanceof XRCPUDepthInformation)){return bodavm.toolsFunc.throwError("TypeError", "Illegal constructor")};this._boisinit=bodavm.config.isinit}
...
bodavm.toolsFunc.defineProperty('XRCPUDepthInformation', "data", {configurable:true, enumerable:true, get:function data (){return bodavm.toolsFunc.dispatch(this, bodavm.memory.globalobj['XRCPUDepthInformation'].prototype, "XRCPUDepthInformation", "data_get", arguments)}, set:undefined},'prototype');
