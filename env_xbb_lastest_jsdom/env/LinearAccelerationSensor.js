...
bodavm.memory.globalobj['LinearAccelerationSensor'] = function LinearAccelerationSensor(){this._boarg= new bodaobj.window.LinearAccelerationSensor();this._boisinit=bodavm.config.isinit}
