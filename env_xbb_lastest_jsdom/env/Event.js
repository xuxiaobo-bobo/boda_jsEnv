// Event对象
bodavm.memory.globalobj['Event'] = function Event(){if (!(this instanceof Event)){return bodavm.toolsFunc.throwError("TypeError", "Failed to construct 'Event': 1 argument required, but only 0 present.")};this._boisinit=bodavm.config.isinit}
...
bodavm.toolsFunc.defineProperty('event', "isTrusted", {configurable:false, enumerable:true, get:function isTrusted (){return bodavm.toolsFunc.dispatch(this, event, "event", "isTrusted_get", arguments, true)}, set:undefined});
