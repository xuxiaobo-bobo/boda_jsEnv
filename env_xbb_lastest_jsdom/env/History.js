// History对象
bodavm.memory.globalobj['History'] = function History(){if (!(this instanceof History)){return bodavm.toolsFunc.throwError("TypeError", "Illegal constructor")};this._boisinit=bodavm.config.isinit}
