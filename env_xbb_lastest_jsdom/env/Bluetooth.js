// Bluetooth对象
bodavm.memory.globalobj['Bluetooth'] = function Bluetooth(){if (!(this instanceof Bluetooth)){return bodavm.toolsFunc.throwError("TypeError", "Illegal constructor")};this._boisinit=bodavm.config.isinit}
