// UIEvent对象
bodavm.memory.globalobj['UIEvent'] = function UIEvent(){if (!(this instanceof UIEvent)){return bodavm.toolsFunc.throwError("TypeError", "Failed to construct 'UIEvent': 1 argument required, but only 0 present.")};this._boisinit=bodavm.config.isinit}
