// HTMLLIElement对象
bodavm.memory.globalobj['HTMLLIElement'] = function HTMLLIElement(){if (!(this instanceof HTMLLIElement)){return bodavm.toolsFunc.throwError("TypeError", "Illegal constructor")};this._boisinit=bodavm.config.isinit}
