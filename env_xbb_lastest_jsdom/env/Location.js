...
bodavm.memory.globalobj['Location'] = function Location(){if (!(this instanceof Location)){return bodavm.toolsFunc.throwError("TypeError", "Illegal constructor")};this._boisinit=bodavm.config.isinit}
...
bodavm.toolsFunc.defineProperty('location', "href", {configurable:false, enumerable:true, get:function href (){return bodavm.toolsFunc.dispatch(this, location, "location", "href_get", arguments, 'http://localhost:63342/%E7%88%AC%E8%99%AB/5s/test.html?_ijt=q7afj33h2bteshkjvmn3buhan8&_ij_reload=RELOAD_ON_SAVE')}, set:function href (){return bodavm.toolsFunc.dispatch(this, location, "location", "href_set", arguments)}});

bodavm.toolsFunc.defineProperty('location', "origin", {configurable:false, enumerable:true, get:function origin (){return bodavm.toolsFunc.dispatch(this, location, "location", "origin_get", arguments, 'http://localhost:63342')}, set:undefined});

bodavm.toolsFunc.defineProperty('location', "protocol", {configurable:false, enumerable:true, get:function protocol (){return bodavm.toolsFunc.dispatch(this, location, "location", "protocol_get", arguments, 'http:')}, set:function protocol (){return bodavm.toolsFunc.dispatch(this, location, "location", "protocol_set", arguments)}});

bodavm.toolsFunc.defineProperty('location', "host", {configurable:false, enumerable:true, get:function host (){return bodavm.toolsFunc.dispatch(this, location, "location", "host_get", arguments, 'localhost:63342')}, set:function host (){return bodavm.toolsFunc.dispatch(this, location, "location", "host_set", arguments)}});

bodavm.toolsFunc.defineProperty('location', "hostname", {configurable:false, enumerable:true, get:function hostname (){return bodavm.toolsFunc.dispatch(this, location, "location", "hostname_get", arguments, 'localhost')}, set:function hostname (){return bodavm.toolsFunc.dispatch(this, location, "location", "hostname_set", arguments)}});

bodavm.toolsFunc.defineProperty('location', "port", {configurable:false, enumerable:true, get:function port (){return bodavm.toolsFunc.dispatch(this, location, "location", "port_get", arguments, '63342')}, set:function port (){return bodavm.toolsFunc.dispatch(this, location, "location", "port_set", arguments)}});

bodavm.toolsFunc.defineProperty('location', "pathname", {configurable:false, enumerable:true, get:function pathname (){return bodavm.toolsFunc.dispatch(this, location, "location", "pathname_get", arguments, '/%E7%88%AC%E8%99%AB/5s/test.html')}, set:function pathname (){return bodavm.toolsFunc.dispatch(this, location, "location", "pathname_set", arguments)}});

bodavm.toolsFunc.defineProperty('location', "search", {configurable:false, enumerable:true, get:function search (){return bodavm.toolsFunc.dispatch(this, location, "location", "search_get", arguments, '?_ijt=q7afj33h2bteshkjvmn3buhan8&_ij_reload=RELOAD_ON_SAVE')}, set:function search (){return bodavm.toolsFunc.dispatch(this, location, "location", "search_set", arguments)}});
