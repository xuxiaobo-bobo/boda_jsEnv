...
bodavm.memory.globalobj['HTMLDocument'] = function HTMLDocument(){if (!(this instanceof HTMLDocument)){return bodavm.toolsFunc.throwError("TypeError", "Illegal constructor")};this._boisinit=bodavm.config.isinit}
