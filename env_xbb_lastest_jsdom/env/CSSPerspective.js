// CSSPerspective对象
bodavm.memory.globalobj['CSSPerspective'] = function CSSPerspective(){if (!(this instanceof CSSPerspective)){return bodavm.toolsFunc.throwError("TypeError", "Failed to construct 'CSSPerspective': 1 argument required, but only 0 present.")};this._boisinit=bodavm.config.isinit}
