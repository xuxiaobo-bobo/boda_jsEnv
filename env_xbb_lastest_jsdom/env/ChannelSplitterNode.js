...
bodavm.memory.globalobj['ChannelSplitterNode'] = function ChannelSplitterNode(){if (!(this instanceof ChannelSplitterNode)){return bodavm.toolsFunc.throwError("TypeError", "Failed to construct 'ChannelSplitterNode': 1 argument required, but only 0 present.")};this._boisinit=bodavm.config.isinit}
