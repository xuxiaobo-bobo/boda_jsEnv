...
bodavm.toolsFunc.defineProperty('CSS', "cqb", {configurable:true, enumerable:true, writable:true, value:function cqb (){return bodavm.toolsFunc.dispatch(this, bodavm.memory.globalobj['CSS'], "CSS", "cqb",  arguments)}});

bodavm.toolsFunc.defineProperty('CSS', "cqh", {configurable:true, enumerable:true, writable:true, value:function cqh (){return bodavm.toolsFunc.dispatch(this, bodavm.memory.globalobj['CSS'], "CSS", "cqh",  arguments)}});

bodavm.toolsFunc.defineProperty('CSS', "cqi", {configurable:true, enumerable:true, writable:true, value:function cqi (){return bodavm.toolsFunc.dispatch(this, bodavm.memory.globalobj['CSS'], "CSS", "cqi",  arguments)}});

bodavm.toolsFunc.defineProperty('CSS', "cqmax", {configurable:true, enumerable:true, writable:true, value:function cqmax (){return bodavm.toolsFunc.dispatch(this, bodavm.memory.globalobj['CSS'], "CSS", "cqmax",  arguments)}});

bodavm.toolsFunc.defineProperty('CSS', "cqmin", {configurable:true, enumerable:true, writable:true, value:function cqmin (){return bodavm.toolsFunc.dispatch(this, bodavm.memory.globalobj['CSS'], "CSS", "cqmin",  arguments)}});

bodavm.toolsFunc.defineProperty('CSS', "cqw", {configurable:true, enumerable:true, writable:true, value:function cqw (){return bodavm.toolsFunc.dispatch(this, bodavm.memory.globalobj['CSS'], "CSS", "cqw",  arguments)}});
...
bodavm.toolsFunc.defineProperty('CSS', "highlights", {configurable:true, enumerable:true, get:function highlights (){return bodavm.toolsFunc.dispatch(this, bodavm.memory.globalobj['CSS'], "CSS", "highlights_get", arguments)}, set:undefined});

bodavm.toolsFunc.defineProperty('CSS', "dvb", {configurable:true, enumerable:true, writable:true, value:function dvb (){return bodavm.toolsFunc.dispatch(this, bodavm.memory.globalobj['CSS'], "CSS", "dvb",  arguments)}});

bodavm.toolsFunc.defineProperty('CSS', "dvh", {configurable:true, enumerable:true, writable:true, value:function dvh (){return bodavm.toolsFunc.dispatch(this, bodavm.memory.globalobj['CSS'], "CSS", "dvh",  arguments)}});

bodavm.toolsFunc.defineProperty('CSS', "dvi", {configurable:true, enumerable:true, writable:true, value:function dvi (){return bodavm.toolsFunc.dispatch(this, bodavm.memory.globalobj['CSS'], "CSS", "dvi",  arguments)}});

bodavm.toolsFunc.defineProperty('CSS', "dvmax", {configurable:true, enumerable:true, writable:true, value:function dvmax (){return bodavm.toolsFunc.dispatch(this, bodavm.memory.globalobj['CSS'], "CSS", "dvmax",  arguments)}});

bodavm.toolsFunc.defineProperty('CSS', "dvmin", {configurable:true, enumerable:true, writable:true, value:function dvmin (){return bodavm.toolsFunc.dispatch(this, bodavm.memory.globalobj['CSS'], "CSS", "dvmin",  arguments)}});

bodavm.toolsFunc.defineProperty('CSS', "dvw", {configurable:true, enumerable:true, writable:true, value:function dvw (){return bodavm.toolsFunc.dispatch(this, bodavm.memory.globalobj['CSS'], "CSS", "dvw",  arguments)}});

bodavm.toolsFunc.defineProperty('CSS', "lvb", {configurable:true, enumerable:true, writable:true, value:function lvb (){return bodavm.toolsFunc.dispatch(this, bodavm.memory.globalobj['CSS'], "CSS", "lvb",  arguments)}});

bodavm.toolsFunc.defineProperty('CSS', "lvh", {configurable:true, enumerable:true, writable:true, value:function lvh (){return bodavm.toolsFunc.dispatch(this, bodavm.memory.globalobj['CSS'], "CSS", "lvh",  arguments)}});

bodavm.toolsFunc.defineProperty('CSS', "lvi", {configurable:true, enumerable:true, writable:true, value:function lvi (){return bodavm.toolsFunc.dispatch(this, bodavm.memory.globalobj['CSS'], "CSS", "lvi",  arguments)}});

bodavm.toolsFunc.defineProperty('CSS', "lvmax", {configurable:true, enumerable:true, writable:true, value:function lvmax (){return bodavm.toolsFunc.dispatch(this, bodavm.memory.globalobj['CSS'], "CSS", "lvmax",  arguments)}});

bodavm.toolsFunc.defineProperty('CSS', "lvmin", {configurable:true, enumerable:true, writable:true, value:function lvmin (){return bodavm.toolsFunc.dispatch(this, bodavm.memory.globalobj['CSS'], "CSS", "lvmin",  arguments)}});

bodavm.toolsFunc.defineProperty('CSS', "lvw", {configurable:true, enumerable:true, writable:true, value:function lvw (){return bodavm.toolsFunc.dispatch(this, bodavm.memory.globalobj['CSS'], "CSS", "lvw",  arguments)}});

bodavm.toolsFunc.defineProperty('CSS', "svb", {configurable:true, enumerable:true, writable:true, value:function svb (){return bodavm.toolsFunc.dispatch(this, bodavm.memory.globalobj['CSS'], "CSS", "svb",  arguments)}});

bodavm.toolsFunc.defineProperty('CSS', "svh", {configurable:true, enumerable:true, writable:true, value:function svh (){return bodavm.toolsFunc.dispatch(this, bodavm.memory.globalobj['CSS'], "CSS", "svh",  arguments)}});

bodavm.toolsFunc.defineProperty('CSS', "svi", {configurable:true, enumerable:true, writable:true, value:function svi (){return bodavm.toolsFunc.dispatch(this, bodavm.memory.globalobj['CSS'], "CSS", "svi",  arguments)}});

bodavm.toolsFunc.defineProperty('CSS', "svmax", {configurable:true, enumerable:true, writable:true, value:function svmax (){return bodavm.toolsFunc.dispatch(this, bodavm.memory.globalobj['CSS'], "CSS", "svmax",  arguments)}});

bodavm.toolsFunc.defineProperty('CSS', "svmin", {configurable:true, enumerable:true, writable:true, value:function svmin (){return bodavm.toolsFunc.dispatch(this, bodavm.memory.globalobj['CSS'], "CSS", "svmin",  arguments)}});

bodavm.toolsFunc.defineProperty('CSS', "svw", {configurable:true, enumerable:true, writable:true, value:function svw (){return bodavm.toolsFunc.dispatch(this, bodavm.memory.globalobj['CSS'], "CSS", "svw",  arguments)}});

bodavm.toolsFunc.defineProperty('CSS', "vb", {configurable:true, enumerable:true, writable:true, value:function vb (){return bodavm.toolsFunc.dispatch(this, bodavm.memory.globalobj['CSS'], "CSS", "vb",  arguments)}});

bodavm.toolsFunc.defineProperty('CSS', "vi", {configurable:true, enumerable:true, writable:true, value:function vi (){return bodavm.toolsFunc.dispatch(this, bodavm.memory.globalobj['CSS'], "CSS", "vi",  arguments)}});
