// SVGPathElement对象
bodavm.memory.globalobj['SVGPathElement'] = function SVGPathElement(){if (!(this instanceof SVGPathElement)){return bodavm.toolsFunc.throwError("TypeError", "Illegal constructor")};this._boisinit=bodavm.config.isinit}
