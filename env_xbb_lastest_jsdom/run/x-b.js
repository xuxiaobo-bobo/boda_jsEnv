...
// }
// window.localStorage = {
//     tt_scid: "yTEPBnH1eLkdVvszONF8MC4LP46FahnFug-1eZu6dW6YSgjmeAd6OSf63BPszE1y6772",
//     getItem: function(a) {
...
window['byted_acrawler'] || function(_0x2fdb61, _0x2c042f) {
    ...
    _0x3059dd['get_xb'] = _0x5a8f25
    _0x3059dd['get_sign'] = _0x26a862
    window.byted_acrawler = _0x3059dd
    Object['defineProperty'](_0x3059dd, '__esModule', {
        'value': !(0x4eb * 0x3 + -0x1026 + 0x77 * 0x3)
    });
});
// x_b=window.byted_acrawler.get_xb('device_platform=webapp&aid=6383&channel=channel_pc_web&publish_video_strategy_type=2&source=channel_pc_web&sec_user_id=MS4wLjABAAAASwDYJLWNaCaNDg31KwOgb9EGxtEHGQo_FgmViPKp0q_7IVpi_CQ-n-Y-Qd6bVkWa&pc_client_type=1&version_code=170400&version_name=17.4.0&cookie_enabled=true&screen_width=1536&screen_height=864&browser_language=zh-CN&browser_platform=Win32&browser_name=Chrome&browser_version=108.0.0.0&browser_online=true&engine_name=Blink&engine_version=108.0.0.0&os_name=Windows&os_version=10&cpu_core_num=8&device_memory=8&platform=PC&downlink=6.6&effective_type=4g&round_trip_time=50&webid=7193589029480433156&msToken=Pda0R2gEOWcRGr0lUJicf8DNsHUYWVUDl0IPkzd07gtfajcp5tXVTZIwYBsXJaxfgajlG2bcLqYS9i9mK8MriiOLd3JQeicHb-ojVlu_PgpfZCmTEX2iDeV3Q1fqmjk=')
// x_b=window.byted_acrawler.get_xb('version_code=180800&resp_content_type=protobuf&did_rule=3&device_id=&device_platform=web&cookie_enabled=true&screen_width=1536&screen_height=864&browser_language=zh-CN&browser_platform=Win32&browser_name=Mozilla&browser_version=5.0%20(Windows%20NT%2010.0;%20Win64;%20x64)%20AppleWebKit/537.36%20(KHTML,%20like%20Gecko)%20Chrome/108.0.0.0%20Safari/537.36&browser_online=true&tz_name=Asia/Hong_Kong&aid=6383&live_id=1&app_name=douyin_web&debug=false&endpoint=live_pc&support_wrds=1&user_unique_id=7193589029480433156&identity=audience&room_id=7195380020393691959&last_rtt=0&fetch_rule=1&cursor=&internal_ext=&msToken=c6kYVq0Q03cYa79a26xFyOzBUbLpq_HtRkeFXLNUd81TVwLJkpa6dPEPmSBjZDNpLUTA3nQFLRDg7ttiD-MiwjDtDD5fGJa--ykUoya3TFa3ASiHbbRMAY9I2Ph99A==')
// x_b=window.byted_acrawler.get_xb('aid=6383&live_id=1&device_platform=web&language=zh-CN&enter_from=web_live&cookie_enabled=true&screen_width=1536&screen_height=864&browser_language=zh-CN&browser_platform=Win32&browser_name=Chrome&browser_version=108.0.0.0&browser_online=true&engine_name=Blink&engine_version=108.0.0.0&os_name=Windows&os_version=10&cpu_core_num=8&device_memory=8&platform=PC&downlink=10&effective_type=4g&round_trip_time=100&channel=channel_pc_web&app_name=douyin_web&webid=7193589029480433156&user_agent=Mozilla%2F5.0+(Windows+NT+10.0%3B+Win64%3B+x64)+AppleWebKit%2F537.36+(KHTML,+like+Gecko)+Chrome%2F108.0.0.0+Safari%2F537.36&fp=&did=0&referer=https:%2F%2Flive.douyin.com%2F63017497693%3Fcover_type%3D0%26enter_from_merge%3Dweb_live%26enter_method%3Dweb_card%26game_name%3D%26is_recommend%3D1%26live_type%3Dgame%26more_detail%3D%26request_id%3D20230202151858CA45ACC2E0D04D13F359%26room_id%3D7195380020393691959%26stream_type%3Dvertical%26title_type%3D1%26web_live_page%3Dhot_live%26web_live_tab%3Dall&target=&device_id=7193589029480433156&webcast_sdk_version=2450&room_id=7195380020393691959&to_room_id=7195380020393691959&sec_anchor_id=MS4wLjABAAAAb8L4Nq4dbSc_X23dmQEBFi8YpwjuxWXM_4yX72UDyu8&sec_to_user_id=MS4wLjABAAAAb8L4Nq4dbSc_X23dmQEBFi8YpwjuxWXM_4yX72UDyu8&gift_scene=1&to_episode_id=0&fetch_giftlist_from=3&msToken=FufymBpP3vzvW_tkciN5VKF2J6WB23zCfrJhhvLOnBfqxRXwSoj0CD9zj0P-rsKp0R8itEuUnyvuEUqANMjZSpMo2tLwWOU1K-4B4xLFsTtj7TtEz5NZ6JfRNRelvg==')
// console.log(x_b);
function get_xb(data) {
    return window.byted_acrawler.get_xb(data)
}

console.log(get_xb('device_platform=webapp&aid=6383&channel=channel_pc_web&tag_id=300203&count=10&Seo-Flag=0&refresh_index=3&pc_client_type=1&version_code=170400&version_name=17.4.0&cookie_enabled=true&screen_width=1536&screen_height=864&browser_language=zh-CN&browser_platform=Win32&browser_name=Chrome&browser_version=108.0.0.0&browser_online=true&engine_name=Blink&engine_version=108.0.0.0&os_name=Windows&os_version=10&cpu_core_num=8&device_memory=8&platform=PC&downlink=10&effective_type=4g&round_trip_time=50&webid=7199485270236382759&msToken=BWk9qQujahwqHMmmT45ktxFLsu3NpWN8xgAbDoj6L_3xYlPuK52cpgY9sW_LEQsj9F7YdR94zIUXLiE-n1IMopR7XrJWal193KmrIbnzZAH-ip03K6PwKuzm_uIW35A='));
