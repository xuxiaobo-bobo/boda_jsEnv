...
SVGGeometryElement = function SVGGeometryElement(){let arg=arguments[0];
if (arg!='bobo' && !(this instanceof SVGGeometryElement) ){return bodavm.toolsFunc.throwError("TypeError", "Illegal constructor")};bodavm.toolsFunc.symbolProperty(this);
if (arg =='bobo'){console.log_copy('SVGGeometryElement 实例化对象 --->',JSON.stringify_bo(arguments,function(k,v){if (v==window){return 'window'}else{return v}}))};}
...
bodavm.toolsFunc.defineProperty(SVGGeometryElement.prototype, "pathLength", {configurable:true, enumerable:true, get:function bodefault (){return bodavm.toolsFunc.dispatch(this, SVGGeometryElement.prototype, "SVGGeometryElement", "bodefault_get", arguments)}, set:undefined},);
