// Node对象
Node = function Node(){let arg=arguments[0];
if (arg!='bobo' && !(this instanceof Node) ){return bodavm.toolsFunc.throwError("TypeError", "Illegal constructor")};bodavm.toolsFunc.symbolProperty(this);
if (arg =='bobo'){console.log_copy('Node 实例化对象 --->',JSON.stringify_bo(arguments,function(k,v){if (v==window){return 'window'}else{return v}}))};}
...
bodavm.toolsFunc.defineProperty(Node.prototype, "nodeType", {configurable:true, enumerable:true, get:function bodefault (){return bodavm.toolsFunc.dispatch(this, Node.prototype, "Node", "bodefault_get", arguments)}, set:undefined},);
bodavm.toolsFunc.defineProperty(Node.prototype, "nodeName", {configurable:true, enumerable:true, get:function bodefault (){return bodavm.toolsFunc.dispatch(this, Node.prototype, "Node", "bodefault_get", arguments)}, set:undefined},);
bodavm.toolsFunc.defineProperty(Node.prototype, "baseURI", {configurable:true, enumerable:true, get:function bodefault (){return bodavm.toolsFunc.dispatch(this, Node.prototype, "Node", "bodefault_get", arguments)}, set:undefined},);
bodavm.toolsFunc.defineProperty(Node.prototype, "isConnected", {configurable:true, enumerable:true, get:function bodefault (){return bodavm.toolsFunc.dispatch(this, Node.prototype, "Node", "bodefault_get", arguments)}, set:undefined},);
bodavm.toolsFunc.defineProperty(Node.prototype, "ownerDocument", {configurable:true, enumerable:true, get:function bodefault (){return bodavm.toolsFunc.dispatch(this, Node.prototype, "Node", "bodefault_get", arguments)}, set:undefined},);
bodavm.toolsFunc.defineProperty(Node.prototype, "parentNode", {configurable:true, enumerable:true, get:function bodefault (){return bodavm.toolsFunc.dispatch(this, Node.prototype, "Node", "bodefault_get", arguments)}, set:undefined},);
bodavm.toolsFunc.defineProperty(Node.prototype, "parentElement", {configurable:true, enumerable:true, get:function bodefault (){return bodavm.toolsFunc.dispatch(this, Node.prototype, "Node", "bodefault_get", arguments)}, set:undefined},);
bodavm.toolsFunc.defineProperty(Node.prototype, "childNodes", {configurable:true, enumerable:true, get:function bodefault (){return bodavm.toolsFunc.dispatch(this, Node.prototype, "Node", "bodefault_get", arguments)}, set:undefined},);
bodavm.toolsFunc.defineProperty(Node.prototype, "firstChild", {configurable:true, enumerable:true, get:function bodefault (){return bodavm.toolsFunc.dispatch(this, Node.prototype, "Node", "bodefault_get", arguments)}, set:undefined},);
bodavm.toolsFunc.defineProperty(Node.prototype, "lastChild", {configurable:true, enumerable:true, get:function bodefault (){return bodavm.toolsFunc.dispatch(this, Node.prototype, "Node", "bodefault_get", arguments)}, set:undefined},);
bodavm.toolsFunc.defineProperty(Node.prototype, "previousSibling", {configurable:true, enumerable:true, get:function bodefault (){return bodavm.toolsFunc.dispatch(this, Node.prototype, "Node", "bodefault_get", arguments)}, set:undefined},);
bodavm.toolsFunc.defineProperty(Node.prototype, "nextSibling", {configurable:true, enumerable:true, get:function bodefault (){return bodavm.toolsFunc.dispatch(this, Node.prototype, "Node", "bodefault_get", arguments)}, set:undefined},);
bodavm.toolsFunc.defineProperty(Node.prototype, "nodeValue", {configurable:true, enumerable:true, get:function bodefault (){return bodavm.toolsFunc.dispatch(this, Node.prototype, "Node", "bodefault_get", arguments)}, set:function bodefault (){return bodavm.toolsFunc.dispatch(this, Node.prototype, "Node", "bodefault_set", arguments)}},);
