// Headers对象
Headers = function Headers(){bodavm.toolsFunc.symbolProperty(this);
if (arg =='bobo'){console.log_copy('Headers 实例化对象 --->',JSON.stringify_bo(arguments,function(k,v){if (v==window){return 'window'}else{return v}}))};}
...
bodavm.toolsFunc.defineProperty(Headers.prototype, "delete", {configurable:true, enumerable:true, writable:true, value:function bodelete (){return bodavm.toolsFunc.dispatch(this, Headers.prototype, "Headers", "bodelete", arguments)}},);
...
bodavm.toolsFunc.defineProperty(Headers.prototype, "getSetCookie", {configurable:true, enumerable:true, writable:true, value:function getSetCookie (){return bodavm.toolsFunc.dispatch(this, Headers.prototype, "Headers", "getSetCookie", arguments)}},);
