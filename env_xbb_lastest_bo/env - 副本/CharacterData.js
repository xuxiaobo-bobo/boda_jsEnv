// CharacterData对象
CharacterData = function CharacterData(){let arg=arguments[0];
if (arg!='bobo' && !(this instanceof CharacterData) ){return bodavm.toolsFunc.throwError("TypeError", "Illegal constructor")};bodavm.toolsFunc.symbolProperty(this);
if (arg =='bobo'){console.log_copy('CharacterData 实例化对象 --->',JSON.stringify_bo(arguments,function(k,v){if (v==window){return 'window'}else{return v}}))};}
...
bodavm.toolsFunc.defineProperty(CharacterData.prototype, "data", {configurable:true, enumerable:true, get:function bodefault (){return bodavm.toolsFunc.dispatch(this, CharacterData.prototype, "CharacterData", "bodefault_get", arguments)}, set:function bodefault (){return bodavm.toolsFunc.dispatch(this, CharacterData.prototype, "CharacterData", "bodefault_set", arguments)}},);
bodavm.toolsFunc.defineProperty(CharacterData.prototype, "length", {configurable:true, enumerable:true, get:function bodefault (){return bodavm.toolsFunc.dispatch(this, CharacterData.prototype, "CharacterData", "bodefault_get", arguments)}, set:undefined},);
bodavm.toolsFunc.defineProperty(CharacterData.prototype, "previousElementSibling", {configurable:true, enumerable:true, get:function bodefault (){return bodavm.toolsFunc.dispatch(this, CharacterData.prototype, "CharacterData", "bodefault_get", arguments)}, set:undefined},);
bodavm.toolsFunc.defineProperty(CharacterData.prototype, "nextElementSibling", {configurable:true, enumerable:true, get:function bodefault (){return bodavm.toolsFunc.dispatch(this, CharacterData.prototype, "CharacterData", "bodefault_get", arguments)}, set:undefined},);
