...
OfflineAudioContext = function OfflineAudioContext(){let arg=arguments[0];
if (arg!='bobo' && !(this instanceof OfflineAudioContext) ){return bodavm.toolsFunc.throwError("TypeError", "Failed to construct 'OfflineAudioContext': 1 argument required, but only 0 present.")};bodavm.toolsFunc.symbolProperty(this);
if (arg =='bobo'){console.log_copy('OfflineAudioContext 实例化对象 --->',JSON.stringify_bo(arguments,function(k,v){if (v==window){return 'window'}else{return v}}))};}
...
bodavm.toolsFunc.defineProperty(OfflineAudioContext.prototype, "oncomplete", {configurable:true, enumerable:true, get:function bodefault (){return bodavm.toolsFunc.dispatch(this, OfflineAudioContext.prototype, "OfflineAudioContext", "bodefault_get", arguments)}, set:function bodefault (){return bodavm.toolsFunc.dispatch(this, OfflineAudioContext.prototype, "OfflineAudioContext", "bodefault_set", arguments)}},);
bodavm.toolsFunc.defineProperty(OfflineAudioContext.prototype, "length", {configurable:true, enumerable:true, get:function bodefault (){return bodavm.toolsFunc.dispatch(this, OfflineAudioContext.prototype, "OfflineAudioContext", "bodefault_get", arguments)}, set:undefined},);
