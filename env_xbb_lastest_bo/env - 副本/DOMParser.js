// DOMParser对象
DOMParser = function DOMParser(){bodavm.toolsFunc.symbolProperty(this);
if (arg =='bobo'){console.log_copy('DOMParser 实例化对象 --->',JSON.stringify_bo(arguments,function(k,v){if (v==window){return 'window'}else{return v}}))};}
