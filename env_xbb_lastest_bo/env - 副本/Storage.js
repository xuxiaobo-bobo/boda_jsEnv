// Storage对象
Storage = function Storage(){let arg=arguments[0];
if (arg!='bobo' && !(this instanceof Storage) ){return bodavm.toolsFunc.throwError("TypeError", "Illegal constructor")};bodavm.toolsFunc.symbolProperty(this);
if (arg =='bobo'){console.log_copy('Storage 实例化对象 --->',JSON.stringify_bo(arguments,function(k,v){if (v==window){return 'window'}else{return v}}))};}

bodavm.toolsFunc.safeProto(Storage, "Storage");
bodavm.toolsFunc.defineProperty(Storage.prototype, "length", {configurable:true, enumerable:true, get:function bodefault (){return bodavm.toolsFunc.dispatch(this, Storage.prototype, "Storage", "bodefault_get", arguments)}, set:undefined},);
