// NamedNodeMap对象
NamedNodeMap = function NamedNodeMap(){let arg=arguments[0];
if (arg!='bobo' && !(this instanceof NamedNodeMap) ){return bodavm.toolsFunc.throwError("TypeError", "Illegal constructor")};bodavm.toolsFunc.symbolProperty(this);
if (arg =='bobo'){console.log_copy('NamedNodeMap 实例化对象 --->',JSON.stringify_bo(arguments,function(k,v){if (v==window){return 'window'}else{return v}}))};}

bodavm.toolsFunc.safeProto(NamedNodeMap, "NamedNodeMap");
bodavm.toolsFunc.defineProperty(NamedNodeMap.prototype, "length", {configurable:true, enumerable:true, get:function bodefault (){return bodavm.toolsFunc.dispatch(this, NamedNodeMap.prototype, "NamedNodeMap", "bodefault_get", arguments)}, set:undefined},);
