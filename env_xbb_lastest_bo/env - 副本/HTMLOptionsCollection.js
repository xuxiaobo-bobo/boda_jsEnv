...
HTMLOptionsCollection = function HTMLOptionsCollection(){let arg=arguments[0];
if (arg!='bobo' && !(this instanceof HTMLOptionsCollection) ){return bodavm.toolsFunc.throwError("TypeError", "Illegal constructor")};bodavm.toolsFunc.symbolProperty(this);
if (arg =='bobo'){console.log_copy('HTMLOptionsCollection 实例化对象 --->',JSON.stringify_bo(arguments,function(k,v){if (v==window){return 'window'}else{return v}}))};}
...
bodavm.toolsFunc.defineProperty(HTMLOptionsCollection.prototype, "remove", {configurable:true, enumerable:true, writable:true, value:function remove (){return bodavm.toolsFunc.dispatch(this, HTMLOptionsCollection.prototype, "HTMLOptionsCollection", "remove", arguments)}},);
