// WaveShaperNode对象
WaveShaperNode = function WaveShaperNode(){let arg=arguments[0];
if (arg!='bobo' && !(this instanceof WaveShaperNode) ){return bodavm.toolsFunc.throwError("TypeError", "Failed to construct 'WaveShaperNode': 1 argument required, but only 0 present.")};bodavm.toolsFunc.symbolProperty(this);
if (arg =='bobo'){console.log_copy('WaveShaperNode 实例化对象 --->',JSON.stringify_bo(arguments,function(k,v){if (v==window){return 'window'}else{return v}}))};}
