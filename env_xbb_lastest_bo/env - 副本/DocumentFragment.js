// DocumentFragment对象
DocumentFragment = function DocumentFragment(){bodavm.toolsFunc.symbolProperty(this);
if (arg =='bobo'){console.log_copy('DocumentFragment 实例化对象 --->',JSON.stringify_bo(arguments,function(k,v){if (v==window){return 'window'}else{return v}}))};}
...
bodavm.toolsFunc.defineProperty(DocumentFragment.prototype, "children", {configurable:true, enumerable:true, get:function bodefault (){return bodavm.toolsFunc.dispatch(this, DocumentFragment.prototype, "DocumentFragment", "bodefault_get", arguments)}, set:undefined},);
bodavm.toolsFunc.defineProperty(DocumentFragment.prototype, "firstElementChild", {configurable:true, enumerable:true, get:function bodefault (){return bodavm.toolsFunc.dispatch(this, DocumentFragment.prototype, "DocumentFragment", "bodefault_get", arguments)}, set:undefined},);
bodavm.toolsFunc.defineProperty(DocumentFragment.prototype, "lastElementChild", {configurable:true, enumerable:true, get:function bodefault (){return bodavm.toolsFunc.dispatch(this, DocumentFragment.prototype, "DocumentFragment", "bodefault_get", arguments)}, set:undefined},);
bodavm.toolsFunc.defineProperty(DocumentFragment.prototype, "childElementCount", {configurable:true, enumerable:true, get:function bodefault (){return bodavm.toolsFunc.dispatch(this, DocumentFragment.prototype, "DocumentFragment", "bodefault_get", arguments)}, set:undefined},);
