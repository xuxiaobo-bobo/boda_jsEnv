// NodeList对象
NodeList = function NodeList(){let arg=arguments[0];
if (arg!='bobo' && !(this instanceof NodeList) ){return bodavm.toolsFunc.throwError("TypeError", "Illegal constructor")};bodavm.toolsFunc.symbolProperty(this);
if (arg =='bobo'){console.log_copy('NodeList 实例化对象 --->',JSON.stringify_bo(arguments,function(k,v){if (v==window){return 'window'}else{return v}}))};}
...
bodavm.toolsFunc.defineProperty(NodeList.prototype, "length", {configurable:true, enumerable:true, get:function bodefault (){return bodavm.toolsFunc.dispatch(this, NodeList.prototype, "NodeList", "bodefault_get", arguments)}, set:undefined},);
