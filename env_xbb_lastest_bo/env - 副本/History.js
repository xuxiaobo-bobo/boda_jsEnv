// History对象
History = function History(){let arg=arguments[0];
if (arg!='bobo' && !(this instanceof History) ){return bodavm.toolsFunc.throwError("TypeError", "Illegal constructor")};bodavm.toolsFunc.symbolProperty(this);
if (arg =='bobo'){console.log_copy('History 实例化对象 --->',JSON.stringify_bo(arguments,function(k,v){if (v==window){return 'window'}else{return v}}))};}

bodavm.toolsFunc.safeProto(History, "History");
bodavm.toolsFunc.defineProperty(History.prototype, "length", {configurable:true, enumerable:true, get:function bodefault (){return bodavm.toolsFunc.dispatch(this, History.prototype, "History", "bodefault_get", arguments)}, set:undefined},);
bodavm.toolsFunc.defineProperty(History.prototype, "scrollRestoration", {configurable:true, enumerable:true, get:function bodefault (){return bodavm.toolsFunc.dispatch(this, History.prototype, "History", "bodefault_get", arguments)}, set:function bodefault (){return bodavm.toolsFunc.dispatch(this, History.prototype, "History", "bodefault_set", arguments)}},);
bodavm.toolsFunc.defineProperty(History.prototype, "state", {configurable:true, enumerable:true, get:function bodefault (){return bodavm.toolsFunc.dispatch(this, History.prototype, "History", "bodefault_get", arguments)}, set:undefined},);
