...
DOMPoint = function DOMPoint(){bodavm.toolsFunc.symbolProperty(this);

if (arg =='bobo'){console.log_copy('DOMPoint 实例化对象 --->',JSON.stringify_bo(arguments,function(k,v){if (v==window){return 'window'}else{return v}}))};}
...
bodavm.toolsFunc.defineProperty(DOMPoint, "fromPoint", {configurable:true, enumerable:true, writable:true, value:function fromPoint (){return bodavm.toolsFunc.dispatch(this, DOMPoint, "DOMPoint", "fromPoint", arguments)}});

bodavm.toolsFunc.defineProperty(DOMPoint.prototype, "x", {configurable:true, enumerable:true, get:function bodefault (){return bodavm.toolsFunc.dispatch(this, DOMPoint.prototype, "DOMPoint", "bodefault_get", arguments)}, set:function bodefault (){return bodavm.toolsFunc.dispatch(this, DOMPoint.prototype, "DOMPoint", "bodefault_set", arguments)}},);
