...
WindowControlsOverlayGeometryChangeEvent = function WindowControlsOverlayGeometryChangeEvent(){let arg=arguments[0];
if (arg!='bobo' && !(this instanceof WindowControlsOverlayGeometryChangeEvent) ){return bodavm.toolsFunc.throwError("TypeError", "Failed to construct 'WindowControlsOverlayGeometryChangeEvent': 2 arguments required, but only 0 present.")};bodavm.toolsFunc.symbolProperty(this);
if (arg =='bobo'){console.log_copy('WindowControlsOverlayGeometryChangeEvent 实例化对象 --->',JSON.stringify_bo(arguments,function(k,v){if (v==window){return 'window'}else{return v}}))};}
