// DocumentType对象
DocumentType = function DocumentType(){let arg=arguments[0];
if (arg!='bobo' && !(this instanceof DocumentType) ){return bodavm.toolsFunc.throwError("TypeError", "Illegal constructor")};bodavm.toolsFunc.symbolProperty(this);
if (arg =='bobo'){console.log_copy('DocumentType 实例化对象 --->',JSON.stringify_bo(arguments,function(k,v){if (v==window){return 'window'}else{return v}}))};}
...
bodavm.toolsFunc.defineProperty(DocumentType.prototype, "name", {configurable:true, enumerable:true, get:function bodefault (){return bodavm.toolsFunc.dispatch(this, DocumentType.prototype, "DocumentType", "bodefault_get", arguments)}, set:undefined},);
bodavm.toolsFunc.defineProperty(DocumentType.prototype, "publicId", {configurable:true, enumerable:true, get:function bodefault (){return bodavm.toolsFunc.dispatch(this, DocumentType.prototype, "DocumentType", "bodefault_get", arguments)}, set:undefined},);
bodavm.toolsFunc.defineProperty(DocumentType.prototype, "systemId", {configurable:true, enumerable:true, get:function bodefault (){return bodavm.toolsFunc.dispatch(this, DocumentType.prototype, "DocumentType", "bodefault_get", arguments)}, set:undefined},);
