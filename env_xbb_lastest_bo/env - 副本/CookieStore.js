// CookieStore对象
CookieStore = function CookieStore(){let arg=arguments[0];
if (arg!='bobo' && !(this instanceof CookieStore) ){return bodavm.toolsFunc.throwError("TypeError", "Illegal constructor")};bodavm.toolsFunc.symbolProperty(this);
if (arg =='bobo'){console.log_copy('CookieStore 实例化对象 --->',JSON.stringify_bo(arguments,function(k,v){if (v==window){return 'window'}else{return v}}))};}
...
bodavm.toolsFunc.defineProperty(CookieStore.prototype, "delete", {configurable:true, enumerable:true, writable:true, value:function bodelete (){return bodavm.toolsFunc.dispatch(this, CookieStore.prototype, "CookieStore", "bodelete", arguments)}},);
...
bodavm.toolsFunc.defineProperty(CookieStore.prototype, "onchange", {configurable:true, enumerable:true, get:function bodefault (){return bodavm.toolsFunc.dispatch(this, CookieStore.prototype, "CookieStore", "bodefault_get", arguments)}, set:function bodefault (){return bodavm.toolsFunc.dispatch(this, CookieStore.prototype, "CookieStore", "bodefault_set", arguments)}},);
