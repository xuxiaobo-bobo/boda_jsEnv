...
// const serialize = require("../serializer/index.js");
// debugger
//Misc constants
...
class Parser {
    ...
    onEndTag(token) {
        ...
        if (this.currentNotInHTML) {
            ...
            // if (token.tagName=='script'){debugger}
...
function endTagInText(p, token) {
    ...
    if (token.tagID === html_js_1.TAG_ID.SCRIPT) {
        ...
        // debugger
        // let boSerialize=boSerialize()
        // let bonode=new Proxy(p.openElements.current.parent,{})
		// boScriptList.push(bonode)
    }
    p.openElements.pop();
