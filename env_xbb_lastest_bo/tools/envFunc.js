...
!function () {
    ...
    bodavm.envFunc.Node_parentElement_get = function Node_parentElement_get() {
        ...
        console.log(`Node_parentElement_get `, `parent${parent} 存在问题需修改 `);
    ...
    bodavm.envFunc.HTMLCanvasElement_width_set = function HTMLCanvasElement_width_set() {
        ...
        if (bodavm.config.isdebug) { debugger }
        console.log(`HTMLCanvasElement_width_set `, `${width}  `);
        this._attrs['width'] = width
        return width
    }

    bodavm.envFunc.HTMLCanvasElement_height_set = function HTMLCanvasElement_width_set() {
        let height = arguments[0];
        if (bodavm.config.isdebug) { debugger }
        console.log(`HTMLCanvasElement_height_set `, `${height}  `);
    ...
    bodavm.envFunc.HTMLCanvasElement_getContext = function HTMLCanvasElement_getContext() {
        ...
        switch (type) {
            ...
            case 'experimental-webgl':
                console.log(`HTMLCanvasElement_getContext `, `type:${type} `, `context:${context}  `)
                context.__proto__ = WebGLRenderingContext.prototype;
                // bodavm.toolsFunc.setProtoAttr.call(context, "canvas", this);
                // bodavm.toolsFunc.setProtoAttr.call(this, "type", type);
                break
    ...
    bodavm.envFunc.HTMLCanvasElement_toDataURL = function HTMLCanvasElement_toDataURL() {
        let type = bodavm.toolsFunc.getProtoAttr.call(this, "type");

        if (type === "2d") {
            let canvas_2d = bodavm.memory.userInit.canvas_2d
            console.log(`HTMLCanvasElement_toDataURL `, `2d:${canvas_2d}  `);
            return canvas_2d;
        } else if (type === "webgl") {
            let canvas_webgl = bodavm.memory.userInit.canvas_webgl
            console.log(`HTMLCanvasElement_toDataURL `, `webgl:${canvas_webgl}  `);
            return canvas_webgl;
        } else if (type === 'experimental-webgl') {
            let canvas_experimental_webgl = bodavm.memory.userInit.canvas_experimental_webgl
            console.log(`HTMLCanvasElement_toDataURL `, `experimental_webgl:${canvas_webgl}  `);
            return canvas_experimental_webgl
        ...
        // console.log(`HTMLCanvasElement_toDataURL `, `canvas:${canvas}  `);

        // return canvas
        // let url = 'data:image/png;base64,'

        // console.log(`HTMLCanvasElement_toDataURL `,${url}  `);
    ...
    bodavm.envFunc.CanvasRenderingContext2D_textBaseline_set = function CanvasRenderingContext2D_textBaseline_set() {
        ...
        bodavm.memory.canvas2D["textBaseline"] = textBaseline
        console.log(`CanvasRenderingContext2D_textBaseline_set `, `${textBaseline}  `);
        if (bodavm.config.isdebug) { debugger }
        return textBaseline
    }
    bodavm.envFunc.CanvasRenderingContext2D_font_set = function CanvasRenderingContext2D_font_set() {
        let font = arguments[0]
        bodavm.memory.canvas2D["font"] = font
        console.log(`CanvasRenderingContext2D_font_set `, `${font}  `);
        if (bodavm.config.isdebug) { debugger }
        return font
    }
    bodavm.envFunc.CanvasRenderingContext2D_fillStyle_set = function CanvasRenderingContext2D_fillStyle_set() {
        ...
        bodavm.memory.canvas2D["fillStyle"] = fillStyle
        console.log(`CanvasRenderingContext2D_fillStyle_set `, `${fillStyle}  `);
        if (bodavm.config.isdebug) { debugger }
        return fillStyle
    }
    bodavm.envFunc.CanvasRenderingContext2D_fillText = function CanvasRenderingContext2D_fillText() {
        ...
        let x = arguments[1]
        let y = arguments[2]
        let maxwidth = arguments[3]
        console.log(`CanvasRenderingContext2D_fillText `, `text:${text} `, `x:${x}, y:${y},maxwidth:${maxwidth}  `);
        if (bodavm.config.isdebug) { debugger }
    ...
    bodavm.envFunc.CanvasRenderingContext2D_fillRect = function CanvasRenderingContext2D_fillRect() {
        ...
        console.log(`CanvasRenderingContext2D_fillRect `, `x:${x}, y:${y}, width:${width}, height:${height}  `);
        if (bodavm.config.isdebug) { debugger }
